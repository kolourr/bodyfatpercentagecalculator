...
function init(content) {
  ...
  <div class="ElementsModal--top-banner">
    <div class="ElementsModal--sales-info">
      ...
      <div style="color: white;font-size: 15px; font-weight: 550; margin-top: 10px;">That's only $1.67/estimate. You owe it to yourself to know your body fat %.</div>
 <div style="color: rgb(62, 184, 139);font-size: 13px; font-weight: 500; margin-top: 10px;">If you are unsatisfied with the result, email contact@estimatebodyfat.com for a full 100% refund.</div>
    </div>
  </div>
